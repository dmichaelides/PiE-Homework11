...
Homeword Assignment #11, in the Python is Easy course with Pirple.

Error handling.  

The project I will apply error handling (including the logging library) to, is Connect 4 - because when I created the Connect 4 game earlier on in the course,
I had to build in a whole lot of IF statements to avoid the Index errors (just so the game could work).

Error handling has been added to the checkwin function and the While loop.
